    ...
    <form onSubmit={onSubmitHandler} className="flex flex-col min-h-[90h] justify-center items-center">
      <div>
        <div className="relative">
          ...
          <span className={`absolute bottom-0 left-0 h-1 bg-blue-500 ${loading ? 'w-full transition-all duraion-[10s]' : 'w-0'}`} />
        </div>
     ...
     {!isImageLoaded && 
       <div className="flex w-full max-w-xl bg-neutral-500 text-white text-sm p-0.5 mt-10 rounded-full">
        ...
        value={input} 
        type="text" placeholder="Describe what you wnat to generate" className="flex-1 bg-transparent outline-none ml-8 max-sm:w-20"/>
