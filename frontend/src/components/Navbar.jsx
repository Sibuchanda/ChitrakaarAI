      ...
      <div>
        {user ? (
          <div className="flex items-center gap-2 sm:gap-3">
           ...
           <p className="text-gray-600 max-sm:hidden pl-4">Hi, Lester</p>
          ...
          <div className="flex items-center gap-2 sm:gap-5">
            ...
            <button onClick={()=>setShowLogin(true)} className="bg-zinc-700 text-white px-7 py-2 sm:px-10 text-sm rounded-full cursor-pointer">
              Login
            </button>
          </div>
        )}
